...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function displayMovies(movies) {
      ...
      movies.forEach(function (movie) {
        _this.resultsTarget.insertAdjacentHTML("beforeend", "<li class='list-inline-item'>\n          <img width=100 src=\"".concat(movie.Poster, "\" alt=\"\" />\n        </li>"));
      });
    }
  }, {
    key: "fetchMovies",
    value: function fetchMovies(keyword) {
      var _this2 = this;

      var url = "https://www.omdbapi.com/?s=".concat(keyword, "&apikey=adf1f2d7");
      fetch(url).then(function (resp) {
        return resp.json();
      }) // json() turns the JSON into some JS object/array when response arrives
      .then(function (data) {
        _this2.resultsTarget.innerHTML = "";
  ...
  return _default;
}(_hotwired_stimulus__WEBPACK_IMPORTED_MODULE_0__["Controller"]); // Transformed into TARGETS
...
_defineProperty(_default, "targets", ['input', 'results']);
